...
class ResNet34(nn.Module):
    def __init__(self, n_classes):
        ...
        self.conv2_2 = ResBlock(nn.Conv2d(64,64,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       ...
                       nn.BatchNorm2d(64), \
                       nn.ReLU())
        self.conv2_3 = ResBlock(nn.Conv2d(64,64,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(64), \
                       nn.ReLU(), \
                       nn.Conv2d(64,64,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(64), \
        ...
        self.conv3_2 = ResBlock(nn.Conv2d(128,128,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       ...
                       nn.BatchNorm2d(128), \
                       nn.ReLU())
        self.conv3_3 = ResBlock(nn.Conv2d(128,128,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(128), \
                       nn.ReLU(), \
                       nn.Conv2d(128,128,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(128), \
                       nn.ReLU())
        self.conv3_4 = ResBlock(nn.Conv2d(128,128,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(128), \
                       nn.ReLU(), \
                       nn.Conv2d(128,128,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(128), \
        ...
        self.conv4_2 = ResBlock(nn.Conv2d(256,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       ...
                       nn.BatchNorm2d(256), \
                       nn.ReLU())
        self.conv4_3 = ResBlock(nn.Conv2d(256,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(256), \
                       nn.ReLU(), \
                       nn.Conv2d(256,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(256), \
                       nn.ReLU())
        self.conv4_4 = ResBlock(nn.Conv2d(256,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(256), \
                       nn.ReLU(), \
                       nn.Conv2d(256,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(256), \
                       nn.ReLU())
        self.conv4_5 = ResBlock(nn.Conv2d(256,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(256), \
                       nn.ReLU(), \
                       nn.Conv2d(256,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(256), \
                       nn.ReLU())
        self.conv4_6 = ResBlock(nn.Conv2d(256,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(256), \
                       nn.ReLU(), \
                       nn.Conv2d(256,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(256), \
        ...
        self.conv5_2 = ResBlock(nn.Conv2d(512,512,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       ...
                       nn.BatchNorm2d(512), \
                       nn.ReLU())
        self.conv5_3 = ResBlock(nn.Conv2d(512,512,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(512), \
                       nn.ReLU(),\
                       nn.Conv2d(512,512,kernel_size=3,stride=1,padding=1,padding_mode='reflect'), \
                       nn.BatchNorm2d(512), \
